  ...
  return (
    <div className="container-dashboard space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatsCard title="Total Documentos" value={0} icon={FileText} />
        <StatsCard title="Pendientes" value={0} icon={Clock} />
        <StatsCard title="Aprobados" value={0} icon={CheckCircle} />
        <StatsCard title="Este Mes" value={0} icon={Upload} />
      </div>
